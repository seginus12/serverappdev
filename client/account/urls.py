...
urlpatterns = [
    ...
    path('logout', TokenBlacklistView.as_view(), name='jwt_token_blacklist'),
    ...
    path('reset_tokens', ResetTokensView.as_view(), name='reset_tokens'),
    ...
    path('get_oauth_url', GetLoginOauthUrlView.as_view(), name='get_oauth_url'),
    path('login_oauth', LoginUserOAuthView.as_view(), name='login_user_oauth'),
    # path('login_oauth', LoginUserOAuthView.as_view(), name='group_permission_crud')
